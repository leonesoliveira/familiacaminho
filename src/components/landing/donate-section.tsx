  ...
  return (
    <div className="grid lg:grid-cols-2 gap-12 items-center">
      <div className="space-y-6 text-center lg:text-left">
        <h2 className="text-3xl font-bold tracking-tight text-primary md:text-4xl">Doe e Abençoe</h2>
      ...
      <div className="flex flex-col items-center justify-center space-y-4 rounded-lg bg-secondary/50 p-8">
        ...
        <p className="font-semibold text-primary">Aponte a câmera para o QR Code (PIX)</p>
